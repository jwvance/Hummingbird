...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000404u)
...
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x48000414u)

/* IOPINS0_6 Address: CYREG_PRT6_DM0 Size (bytes): 8 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x4800041Cu)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SAR0_SW4, 0x10u);
