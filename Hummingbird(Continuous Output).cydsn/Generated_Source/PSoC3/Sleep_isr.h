...
#define Sleep_isr_INTC_VECTOR            ((reg16 *) Sleep_isr__INTC_VECT)
...
#define Sleep_isr_INTC_SET_EN            ((reg8 *) Sleep_isr__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the Sleep_isr interrupt. */
#define Sleep_isr_INTC_CLR_EN            ((reg8 *) Sleep_isr__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the Sleep_isr interrupt state to pending. */
#define Sleep_isr_INTC_SET_PD            ((reg8 *) Sleep_isr__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the Sleep_isr interrupt. */
#define Sleep_isr_INTC_CLR_PD            ((reg8 *) Sleep_isr__INTC_CLR_PD_REG)
