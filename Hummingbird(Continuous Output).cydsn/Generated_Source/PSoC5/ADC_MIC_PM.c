...
*  The ADC_MIC_Sleep() routine saves the current component state,
...
*
* Global Variables:
*  ADC_MIC_backup - The structure field 'enableState' is modified
*  depending on the enable state of the block before entering to sleep mode.
*
*******************************************************************************/
void ADC_MIC_Sleep(void)
{
    if((ADC_MIC_PWRMGR_SAR_REG  & ADC_MIC_ACT_PWR_SAR_EN) != 0u)
    {
        if((ADC_MIC_SAR_CSR0_REG & ADC_MIC_SAR_SOF_START_CONV) != 0u)
        {
...
*  ADC_MIC_Sleep() was called. If the component was enabled before the
*  ADC_MIC_Sleep() function was called, the
*  ADC_MIC_Wakeup() function also re-enables the component.
*
* Parameters:
*  None.
*
...
*
* Global Variables:
*  ADC_MIC_backup - The structure field 'enableState' is used to
