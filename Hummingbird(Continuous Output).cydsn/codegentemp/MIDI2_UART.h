...
#define MIDI2_UART_TXBUFFERSIZE                   (255u)
#define MIDI2_UART_RXBUFFERSIZE                   (255u)
...
#define MIDI2_UART_BIT_CENTER                         (MIDI2_UART_OVER_SAMPLE_COUNT - 1u)
...
extern uint8 MIDI2_UART_initVar;
    ...
    extern volatile uint8 MIDI2_UART_txBuffer[MIDI2_UART_TXBUFFERSIZE];
...
#if (MIDI2_UART_RXHW_ADDRESS_ENABLED)
    #define MIDI2_UART_RXADDRESSMODE      (0u)
    #define MIDI2_UART_RXHWADDRESS1       (0u)
    #define MIDI2_UART_RXHWADDRESS2       (0u)
