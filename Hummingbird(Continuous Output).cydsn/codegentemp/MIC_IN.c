...
*
* \funcusage
*  \snippet MIC_IN_SUT.c usage_MIC_IN_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet MIC_IN_SUT.c usage_MIC_IN_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet MIC_IN_SUT.c usage_MIC_IN_Read  
*******************************************************************************/
...
* preferred MIC_IN_Read() API because the 
* MIC_IN_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet MIC_IN_SUT.c usage_MIC_IN_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: MIC_IN_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use MIC_IN_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - MIC_IN_0_INTR       (First pin in the list)
    *  - MIC_IN_1_INTR       (Second pin in the list)
    *  - ...
    *  - MIC_IN_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet MIC_IN_SUT.c usage_MIC_IN_SetInterruptMode
    *******************************************************************************/
    void MIC_IN_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & MIC_IN_0_INTR) != 0u) 
		{ 
			 MIC_IN_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet MIC_IN_SUT.c usage_MIC_IN_ClearInterrupt
    *******************************************************************************/
