...
#define BS_IDMUX_IRQ_VAL ((const uint8 CYFAR *)0x48000E5Cu)

/* UDB_1_1_0_CONFIG Address: CYDEV_UCFG_B1_P3_U1_BASE Size (bytes): 128 */
#define BS_UDB_1_1_0_CONFIG_VAL ((const uint8 CYFAR *)0x48000E64u)

/* UCFG_BCTL0 Address: CYREG_BCTL0_MDCLK_EN Size (bytes): 16 */
#define BS_UCFG_BCTL0_VAL ((const uint8 CYFAR *)0x48000EE4u)
...
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)0x48000F28u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT2_AMUX, 0x6106u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT15_AMUX, 0x0808u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SAR0_SW0, 0x81u);
