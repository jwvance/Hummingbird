...
namespace CharLCD_I2C_v2_0
{
    public partial class CyCharLCDControl : UserControl
    {
        ...
        {
            CharLCD_I2C_v2_0.CyCustomCharacter selectedCharacter = (CharLCD_I2C_v2_0.CyCustomCharacter)sender;
        ...
        public void CYStringToCharacter(CyCustomCharacter customCharacter, string cyCharacterString)
        {
            ...
            CharLCD_I2C_v2_0.CyBox[,] boxes = customCharacter.GetBoxArray();
        ...
        public string CharacterToCYString(CyCustomCharacter customCharacter)
        {
            ...
            CharLCD_I2C_v2_0.CyBox[,] pixelArray = customCharacter.GetBoxArray();
        ...
        private void HighlightNext()
        {
            ...
            UpdateHighlighted((CharLCD_I2C_v2_0.CyCustomCharacter)m_userDefinedCharacters[next]);
        }
        ...
        private void HighlightPrevious()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCD_I2C_v2_0.CyCustomCharacter)m_userDefinedCharacters[previous]);
        }
        ...
        private void HighlightAbove()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCD_I2C_v2_0.CyCustomCharacter)m_userDefinedCharacters[above]);
        }
        private void HighlightBelow()
        {
            ...
            // Cast from Object to CustomCharacter
            UpdateHighlighted((CharLCD_I2C_v2_0.CyCustomCharacter)m_userDefinedCharacters[below]);
        }
        ...
        private void CustomCharactersOff()
        {
            ...
            for (int i = 0; i < this.panel1.Controls.Count; i++)
            {
                CharLCD_I2C_v2_0.CyCustomCharacter character = (CharLCD_I2C_v2_0.CyCustomCharacter)this.panel1.Controls[i];
